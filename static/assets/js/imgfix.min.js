...
!(function (a) {
    function t(t) {
        ...
        (null != s.data('fix-defaults-grayscale') ||
            ...
            ((c =
                null != s.data('fix-defaults-grayscale')
                    ? 'grayscale(' +
                      parseInt(s.data('fix-defaults-grayscale')) +
                      '%) '
                    : ''),
            (c +=
                null != s.data('fix-defaults-sepia')
            ...
            (c +=
                null != s.data('fix-defaults-hue')
                    ? 'hue-rotate(' +
                      parseInt(s.data('fix-defaults-hue')) +
                      'deg) '
                    : ''),
            (c +=
                null != s.data('fix-defaults-saturate')
                    ? 'saturate(' +
                      parseInt(s.data('fix-defaults-saturate')) +
                      'deg) '
                    : ''),
            (c +=
                null != s.data('fix-defaults-invert')
                    ? 'invert(' +
                      parseInt(s.data('fix-defaults-invert')) +
                      '%) '
                    : ''),
            (c +=
                null != s.data('fix-defaults-brightness')
                    ? 'brightness(' +
                      parseInt(s.data('fix-defaults-brightness')) +
                      '%) '
                    : ''),
            (c +=
                null != s.data('fix-defaults-contrast')
                    ? 'contrast(' +
                      parseInt(s.data('fix-defaults-contrast')) +
                      '%) '
                    : ''),
            (c +=
                null != s.data('fix-defaults-blur')
            ...
            case 'dynamic':
                t.addClass('imgfix-in-up'),
                    a(i).on('mouseenter', t, function (t) {
                        var e = t.data
                                .parents('.imgfix_wrapper_layer')[0]
                                .id.split('_')[3],
    ...
    function s(a, t) {
        'imgfix-in-up' != t && a.removeClass('imgfix-in-up'),
            ...
            'imgfix-in-down-right' != t &&
                a.removeClass('imgfix-in-down-right'),
        ...
        init: function (e, s) {
            ...
            l.cover || (l.cover = {}),
                ...
                (l = {
                    ...
                    brightness:
                        parseInt(l.brightness) >= 0 ? l.brightness : null,
                    ...
                    defaults: {
                        ...
                        grayscale:
                            parseInt(l.defaults.grayscale) >= 0
                                ? l.defaults.grayscale
                                : null,
                        sepia:
                            parseInt(l.defaults.sepia) >= 0
                                ? l.defaults.sepia
                                : null,
                        hue:
                            parseInt(l.defaults.hue) >= 0
                                ? l.defaults.hue
                                : null,
                        saturate:
                            parseInt(l.defaults.saturate) >= 0
                                ? l.defaults.saturate
                                : null,
                        invert:
                            parseInt(l.defaults.invert) >= 0
                                ? l.defaults.invert
                                : null,
                        brightness:
                            parseInt(l.defaults.brightness) >= 0
                                ...
                                : null,
                        contrast:
                            parseInt(l.defaults.contrast) >= 0
                                ? l.defaults.contrast
                                : null,
                        blur:
                            parseInt(l.defaults.blur) >= 0
                                ? l.defaults.blur
                                : null,
                    },
            ...
            for (var n = 0; n < d.length; n++) {
                ...
                if (s)
                    null == o.data('fix-img') && o.data('fix-img', ''),
                        o.data(
                            'fix-fixin',
                            l.fixin ? l.fixin : o.data('fix-fixin')
                        ),
                        o.data(
                            'fix-defaults-scale',
                            l.defaults.scale
                        ...
                        o.data(
                            'fix-hue',
                            null != l.hue ? l.hue : o.data('fix-hue')
                        ),
                        o.data(
                            'fix-saturate',
                            null != l.saturate
                        ...
                        o.data(
                            'fix-blur',
                            null != l.blur ? l.blur : o.data('fix-blur')
                        ),
                        o.data(
                            'fix-width',
                            l.width ? l.width : o.data('fix-width')
                        ),
                        o.data(
                            'fix-height',
                            l.height ? l.height : o.data('fix-height')
                        ),
                        o.data(
                        ...
                        o.data(
                            'fix-easing',
                            l.easing ? l.easing : o.data('fix-easing')
                        ),
                        o.data(
                            'fix-cover',
                    ...
                    if (
                        ...
                        o.data(
                            'fix-blur',
                            null == o.data('fix-blur')
                                ? l.blur
                                : o.data('fix-blur')
                        ),
                        o.data(
                            'fix-width',
                            null == o.data('fix-width')
                                ? l.width
                                : o.data('fix-width')
                        ),
                        o.data(
                            'fix-height',
                            null == o.data('fix-height')
                                ? l.height
                                : o.data('fix-height')
                        ),
                        o.data(
                        ...
                        o.data(
                            'fix-easing',
                            null == o.data('fix-easing')
                                ? l.easing
                                : o.data('fix-easing')
                        ),
                        o.data(
                            'fix-cover',
                            null == o.data('fix-cover')
                                ? l.coverclass
                                : o.data('fix-cover')
                        ),
                        o.data(
                    ...
                    (h =
                        ...
                        u &&
                            o
                                .find(h)
                                .wrap(
                                    '<div class="imgfix_cover_wrapper"></div>'
                                );
                    var m = o.find('.imgfix_cover_wrapper');
                    m.css({
                        width:
                            a(o.find('.imgfix_wrapper_layer')[0]).width() +
                            'px',
                        height:
                            a(o.find('.imgfix_wrapper_layer')[0]).height() +
                            'px',
                    }),
    ...
    (a.fn.imgfix = function (t) {
        ...
        (a.fn.imgfixRefresh = function () {
            for (
                var t = a(this).find('.imgfix_wrapper_layer'),
                    e = new Array(),
                    i = 0;
                i < t.length;
                i++
